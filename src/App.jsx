...
const CalculatorMain = ({
  mode, setMode, salary, setSalary, war, setWar, wrcPlus, setWrcPlus, position, setPosition, teamPayroll, setTeamPayroll, teamWAR, setTeamWAR, warType, setWarType, payrollType, setPayrollType, results, setResults, errors, setErrors, selectedPlayer, setSelectedPlayer, useEnhancedForm, setUseEnhancedForm, history, showHistory, addToHistory, clearHistory, toggleHistory, handleModeChange, handleExampleSelect, handleCalculate, handleClear, LEAGUE_DATA
}) => (
